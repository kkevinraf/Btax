 ...
 *
 */
class ReservationCooperativeController extends Controller
{
    public function searchAction()
    {
        return $this->render('CooperativeBundle:Admin:Reservation/search.html.twig', array('p_reservation' => 'active',));
    }

    public function searchAdvancedAction()
    {
        $localisation = $this->getLocalisation();
        return $this->render('CooperativeBundle:Admin:Reservation/searchAdvanced.html.twig', array('localisation' => $localisation, 'p_reservation' => 'active',));
    }
    ...
    public function searchRunAction()
    {
        ...
        if($request->getMethod() == "POST")
        {
            ...
            return $this->render('CooperativeBundle:Admin:Reservation/result.html.twig', array(
                'data' => $data,
