...
class __TwigTemplate_958274502809a67f0142e7e6c700de61bc7142d705703fe83a723ea66af1a301 extends Twig_Template
{
...
\t\t\t\t<form action=\"";
        // line 58
        echo $this->env->getExtension('routing')->getPath("utilisateur_creat_user");
        echo "\" method=\"POST\">
\t\t\t\t";
        // line 59
...
\t\t\t\t\t\t<input class=\"login-input\" type=\"text\" name=\"nom\" required=\"\">
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t\t<div class=\"form-login-body\">
\t\t\t\t\t<div class=\"group-input-login\">
...
\t\t\t\t<div class=\"form-login-body\">
\t\t\t\t\t<div class=\"group-input-login\">
\t\t\t\t\t\t<span class=\"login-label\">Préférence de langue </span><br>
\t\t\t\t\t\t<select name=\"langue\" class=\"login-input\" required>
