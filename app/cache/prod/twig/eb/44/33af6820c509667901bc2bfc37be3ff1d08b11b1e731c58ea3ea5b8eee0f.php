...
\t\t\t\t";
                // line 46
                echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("Vos critères"), "html", null, true);
                echo " :
\t\t\t</div>
...
\t\t";
            // line 74
            echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("Aucune recherche enregistrée"), "html", null, true);
            echo "
\t\t</div>
