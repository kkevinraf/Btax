...
/* BookBundle:Logout:errorpaiement_logout.html.twig */
class __TwigTemplate_2013112433a01f5e146cfb012390fee39a14b37bf383cd923d2c4bfdaaa3e95b extends Twig_Template
{
...
\t\t\t\tVotre compte n'a pas été débité, vous pouvez effectuer une nouvelle tentative de paiement.
\t\t\t\t</div>\t
\t\t\t\t<div class=\"btn-back\">
\t\t\t\t\t<a href=\"";
        // line 69
        echo $this->env->getExtension('routing')->getPath("search_log_out");
        echo "\"><button class=\"refused-btn\">Revenir sur le site</button></a>
\t\t\t\t</div>\t
\t\t\t</div>
\t\t</div>
\t</div>
    ...
    {
        return "BookBundle:Logout:errorpaiement_logout.html.twig";
    }
