...
/* CooperativeBundle:Admin/Place:index.html.twig */
class __TwigTemplate_618b631c57b1204cc682c2399be84b781ee3aee40fbab00b57c84f2f7cce6c75 extends Twig_Template
{
    ...
    public function block_body($context, array $blocks = array())
    {
        ...
        if ((twig_length_filter($this->env, $_entities_) == 0)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
                ...
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("place_show", array("id" => $this->getAttribute($_entity_, "id"))), "html", null, true);
                echo "\">";
                if (isset($context["entity"])) { $_entity_ = $context["entity"]; } else { $_entity_ = null; }
    ...
    {
        return "CooperativeBundle:Admin/Place:index.html.twig";
    }
