 ...
 */
class Localisation extends \Btax\BtaxBundle\Entity\Localisation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'localisation', 'photo', 'file');
        }
