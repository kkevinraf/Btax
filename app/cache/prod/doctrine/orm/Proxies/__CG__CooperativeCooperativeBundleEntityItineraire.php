 ...
 */
class Itineraire extends \Cooperative\CooperativeBundle\Entity\Itineraire implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'depart', 'destination');
        }
