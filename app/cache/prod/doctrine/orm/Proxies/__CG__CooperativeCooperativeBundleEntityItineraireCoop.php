 ...
 */
class ItineraireCoop extends \Cooperative\CooperativeBundle\Entity\ItineraireCoop implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'prix', 'cooperative', 'place', 'itineraire');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ItineraireCoop $proxy) {
    ...
    public function setDefault($cooperative, $place)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDefault', array($cooperative, $place));

        return parent::setDefault($cooperative, $place);
    }
